...
@NamedQueries({
	...
	@NamedQuery(name="PrepaidRechargeEntity.getAllRecordForTally",query="SELECT pp FROM PrepaidRechargeEntity pp where EXTRACT(month FROM pp.txn_Date)=:month AND EXTRACT(year FROM pp.txn_Date)=:year AND pp.tallyStatus like 'Not Posted'"),
...
public class PrepaidRechargeEntity {
	...
	private String recharge_Request_No;
	...
	public String getRecharge_Request_No() {
		return recharge_Request_No;
	}

	public void setRecharge_Request_No(String recharge_Request_No) {
		this.recharge_Request_No = recharge_Request_No;
	}
