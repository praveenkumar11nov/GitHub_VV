...
import com.bcits.bfm.util.PaymentRemainderMailSender;
import com.bcits.bfm.util.SendPaymentRemainderInfoSMS;
			...
			throws ParseException 
	  {
	   ...
	   if(billEntity.getPostType().equalsIgnoreCase("Back Bill"))
		...
		if(billEntity.getTypeOfService().equalsIgnoreCase("Others"))
		{
			...
			billLineItemEntities = electricityBillLineItemService.findAllLineItemsByIdUpdate(elBillId);
	...
	public void paymentRemainderSheduler() throws Exception{
		...
		for (ElectricityBillEntity electricityBillEntity : billsAfterDueDateList) {
			...
			String messageContentForPerson = "<html>"						   
					...
					+ "}"
					+ "</style>"
					+ "<h2  align=\"center\"  style=\"background-color:#88ab74;\">Victory Valley RWA Payment Desk Service</h2> <br /> Dear "+personName+", <br/> <br/> "
					...
					+"Victory Valley RWA<br/><br/> <h7>This is an auto generated Email.Please do not revert back</h7>"
					+"</body></html>";
		...
		for (ElectricityBillEntity electricityBillEntity : billsDueDateList) {
			...
			String messageContentForPerson = "<html>"						   
					...
					+"Thank you very much, and have a nice day.<br/><br/>"
					+"<br/>Payment Services,<br/>"
					+"Victory Valley RWA<br/><br/> <h7>This is an auto generated Email.Please dont revert back</h7>"
					+"</body></html>";
