...
public class TallyPostingPrePaidRecieptsService {
	...
	public String generateXML(List<Map<String, Object>> mapsList, String receiptNumber, Date cashReceiptDate,
		...
		}else if(paymentMode.equalsIgnoreCase("RTGS/NEFT")){
		...
		else if(paymentMode.trim().equalsIgnoreCase("AdvancePayment")){
		...
		}else if(paymentMode.equalsIgnoreCase("NB") || paymentMode.equalsIgnoreCase("CC") || paymentMode.equalsIgnoreCase("DC") || paymentMode.equalsIgnoreCase("PPI") || paymentMode.equalsIgnoreCase("Online")){
	...
	public String getBankAllocationDetails(List<Map<String, Object>> list,
		...
		for (int i = 0; i < bankListReceipt.size(); i++) {
		 ...
		 CommonTally commonTally = new CommonTally();
	     Voucher voucher = commonTally.getInventories("<VOUCHER> "+xmlInventories+"</VOUCHER>");
