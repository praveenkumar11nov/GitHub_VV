				...
				logger.info("Contact Number Not Found For "+ ownerName);
				      ...
				      String messageContent = 
								"<html>"
										...
										+ "}"
										+ "</style>"
										+ "<h2  align=\"center\"  style=\"background-color:#88ab74;\">VICTORY VALLEY RWA MAINTENACE MANAGEMENT.</h2> <br/><br /> Dear "
										+ ownerName
										+ ",<br/> <br/> "
										...
										+ "<br/><br/>"
										+ "<br/>Thanks,<br/>"
										+ "VICTORY VALLEY RWA MAINTENACE MANAGEMENT. <br/> <br/> This is Auto Generated Mail, Please Don't Revert Back"
										+"</body></html>";
