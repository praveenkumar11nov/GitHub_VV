		...
		if (errorMessage == null || errorMessage.equals("")) {
			...
			EmailCredentialsDetailsBean emailCredentialsDetailsBean=null;
			 ...
			 String messageContent="<html>"
						...
						+ "}"
						+ "</style>"
						+ "<h2  align=\"center\"  style=\"background-color:#88ab74;\">VICTOY VALLEY ADMINISTRATION DEPARTMENT</h2> <br /> Dear VICTOY VALLEY, Welcome to IREO <br/> <br/> "
						...
						+ "<br/><br/>"
						+ "<br/>Thanks,<br/>"
						+ "Victoy Valley Administration Department <br/> <br/>"
						+"</body></html>";	
