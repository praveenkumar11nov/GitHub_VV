...
public class PrePaidTransactionMasterController {
	...
	public @ResponseBody Object saveCalculation(@PathVariable int serviceId,@ModelAttribute("prepaidTxnChargesEntity") PrepaidTxnChargesEntity prepaidTxnChargesEntity,HttpServletRequest request){
