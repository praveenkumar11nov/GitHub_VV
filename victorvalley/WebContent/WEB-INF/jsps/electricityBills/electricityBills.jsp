...
<c:url value="/camConsolidation/readAccountNumbers"
	...
	<div id="postAllTallydiv" style="display: none;">
	<form id="postAllTallyForm" data-role="validator" novalidate="novalidate">
		<table style="height: 190px;">
			<tr>
				<td>Service Type</td>
				<td><input  id="serviceTypeTally" name="serviceTypeTally"
			...
			<tr>
				<td> Month</td>
				<td><kendo:datePicker format="MMM yyyy  "
						name="presentdatepostBill" id="presentdatepostBill" required="required" value="${month}" start="year"
            ...
            <tr>
				<td class="left" align="center" colspan="4">                    
					<button type="submit" id="postTallyBill" class="k-button"
						style="padding-left: 10px">Post All Bills</button>
...
<!-- ----------------------------------------------------------TallyXML---------------------------------------------- -->
<div id="ExportTallyXMLdiv" style="display: none;">
	<form id="ExportTallyXMLForm" data-role="validator"
		novalidate="novalidate">
		<table style="height: 190px;">
			<tr>
				<td>Service Type</td>
				<td><input id="serviceTypeTallyXML" name="serviceTypeTallyXML"
			...
			<tr>
				<td class="left" align="center" colspan="4">
					<button type="submit" id="exportTallyBillData" class="k-button"
...
<kendo:grid name="billGrid" change="onChangeBillsList" resizable="true"
	...
	<kendo:grid-toolbar>
	    <kendo:grid-toolbarItem template="<input id='generateDropDown' style='width:162px' placeholder='Genereate Bills...' />" />
		<%-- <kendo:grid-toolbarItem name="generateBill" text="Generate Bill" />
		<kendo:grid-toolbarItem name="generateBTBill"
			text="Generate BroadBand & Telecom Bill" />
		<kendo:grid-toolbarItem name="generateBulkBill"
			text="Generate Bulk Bill" />
		<kendo:grid-toolbarItem name="raiseDD" text="Raise Deposit Demand" /> --%>
		<kendo:grid-toolbarItem name="create" text="Generate Back Bill" />
		<kendo:grid-toolbarItem name="uploadBatchFile" text="Upload Batch File" />
		<%-- <kendo:grid-toolbarItem name="uploadXMLFile" text="Upload XML File" /> --%>
		<%-- <kendo:grid-toolbarItem name="generateCamBill"
			text="Generate CAM Bill" /> --%>
			<kendo:grid-toolbarItem name="cancelAllBills" text="Cancel All Bills" />
		<kendo:grid-toolbarItem name="approveAllBills" text="Approve All Bills" />
		<kendo:grid-toolbarItem name="postAllBills" text="Post All Bills" />
	    <kendo:grid-toolbarItem name="postAllBillsToTally" text="Post All To Tally" /> 
		<%-- <kendo:grid-toolbarItem name="amrBilling" text="Generate AMR Bill" /> --%>
		<kendo:grid-toolbarItem name="downloadAllBills" text="Download All Bills" />
		...
		<br/><br/>
		<kendo:grid-toolbarItem name="ExportTallyDataToXML"	text="Export Tally Data To XML" />
		
		<kendo:grid-toolbarItem template="<div style='margin-top:10px'>&nbsp;&nbsp;&nbsp; <span class='bgBlueColor' style='width:60px; height :20px;margin-left: 7px;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>&nbsp;&nbsp;: Generated" />
		<kendo:grid-toolbarItem template="&nbsp;&nbsp;&nbsp;<span class='bgRedColor' style='width:60px; height :20px'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>&nbsp;&nbsp;: Cancelled" />
		<kendo:grid-toolbarItem template="&nbsp;&nbsp;&nbsp;<span class='bgGreenColor' style='width:60px; height :20px'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>&nbsp;&nbsp;: Posted" />
		<kendo:grid-toolbarItem template="&nbsp;&nbsp;&nbsp;<span class='bgYellowColor' style='width:60px; height :20px'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>&nbsp;&nbsp;: Approved" />
		<kendo:grid-toolbarItem template="&nbsp;&nbsp;&nbsp;<span class='bgKhakiColor' style='width:60px; height :20px'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>&nbsp;&nbsp;: Paid</div>" />
	</kendo:grid-toolbar>
	...
	<kendo:grid-columns>
		...
		<kendo:grid-column title="Account&nbsp;No" field="accountNumber" filterable="true" width="85px">
		...
		<kendo:grid-column title="Cleared&nbsp;Amount"
			field="advanceClearedAmount" filterable="true" width="110px" hidden="true" />
		...
		<kendo:grid-column title="Post&nbsp;Type" field="postType"
			width="80px" filterable="true" editor="dropDownChecksEditor" hidden="true">
			<kendo:grid-column-filterable>
				<kendo:grid-column-filterable-ui>
					<script>
						function postTypeFilter(element) {
		...
		<kendo:grid-column title="&nbsp;" width="100px">
			<kendo:grid-column-command>
				<kendo:grid-column-commandItem name="Cancel" click="cancelApproveBill" />
				<kendo:grid-column-commandItem name="Correct Bill" click="correctBill" />
			</kendo:grid-column-command>
		</kendo:grid-column>
		...
		<kendo:grid-column title="&nbsp;" width="100px">
			<kendo:grid-column-command>
				<kendo:grid-column-commandItem name="Delete Bill" click="deleteBill" />
			</kendo:grid-column-command>
		</kendo:grid-column>
			...
			<kendo:splitter-pane id="top-pane" collapsible="false">
				<kendo:splitter-pane-content>
					<kendo:splitter name="horizontal_#=elBillId#"
						...
						<kendo:splitter-panes>
							<kendo:splitter-pane id="left-pane" collapsible="true" size="400px">
								<kendo:splitter-pane-content>
						...
						<div class='bill-details' style='width: auto;'>
							...
							<kendo:splitter-pane id="center-pane" collapsible="true" size="500px">
								<kendo:splitter-pane-content>
									<div class="pane-content">
		...
		<table style="height: 270px;">
			<tr>
				...
				<td><input id="blockName" name="blockName" required="required"
					onchange="onselectedProperty()" validationMessage="Select Block Name" />
					<!-- onchange="getPropertyNo()" --></td>
			</tr>
		...
		<table style="height: 190px;">
			<tr>
				...
				<td><input id="blockNameAmr" name="blockNameAmr"
					required="required" 
					validationMessage="Select Block Name" onchange="getPropertyNoAmr()" /> <!-- onchange="getPropertyNo()" --></td>
			</tr>
			<tr>
				<td>Property Type</td>
			...
			<tr>
				<td class="left" align="center" colspan="4">
                     <button type="button" id="verify" class="k-button" style="padding-left: 10px">Verify</button>
...
<div id="printBillingDiv" style="display: none;">
	<form id="printBillingForm" data-role="validator" novalidate="novalidate">
		<table style="height: 190px;">
		   ...
		   <tr>
				<td>Print Bill</td>
				<td><input  id="typePrint" name="typePrint"
					required="required" 
					validationMessage="Select Service Type"  onchange="billTOPrint()" /> </td>
			</tr>
			...
			<tr>
				<td class="left" align="center" colspan="4">                    
					<button type="submit" id="printBill" class="k-button"
						style="padding-left: 10px">Print Bill</button>
					<span id=printplaceholder style="display: none;"><img
						src="./resources/images/loadingimg.GIF"
						style="vertical-align: middle; margin-left: 50px" /> &nbsp;&nbsp;
						<img src="./resources/images/loading.GIF" alt="loading"
	...
	<form id="cancelAllForm" data-role="validator" novalidate="novalidate">
		<table style="height: 190px;">
			...
			<tr>
				<td> Month</td>
				<td><kendo:datePicker format="MMM yyyy  "
						name="presentdatecancelBill" id="presentdatecancelBill" required="required" value="${month}" start="year"
						class="validate[required]" validationMessage="Date is Required" depth="year">
					</kendo:datePicker>
				<td></td>
			</tr>
			...
			<tr>
				<td class="left" align="center" colspan="4">                    
					<button type="submit" id="cancelBill" class="k-button"
						style="padding-left: 10px">Cancel All Bills</button>
					<!-- <span id=printplaceholder style="display: none;"><img
						src="./resources/images/loadingimg.GIF"
						style="vertical-align: middle; margin-left: 50px" /> &nbsp;&nbsp;
						<img src="./resources/images/loading.GIF" alt="loading"
						style="vertical-align: middle margin-left: 50px" height="20px"
						width="200px; " /></span> -->
						<span id=commitplaceholderNewCancel style="display: none;">
					<img
	...
	<form id="approveAllForm" data-role="validator" novalidate="novalidate">
		<table style="height: 190px;">
			...
			<tr>
				<td> Month</td>
				<td><kendo:datePicker format="MMM yyyy  "
						name="presentdateapproveBill" id="presentdateapproveBill" required="required" value="${month}" start="year"
						class="validate[required]" validationMessage="Date is Required" depth="year">
					</kendo:datePicker>
				<td></td>
			</tr>
			...
			<tr>
				<td class="left" align="center" colspan="4">                    
					<button type="submit" id="approveBill" class="k-button"
						style="padding-left: 10px">Approve All Bills</button>
					<!-- <span id=printplaceholder style="display: none;"><img
						src="./resources/images/loadingimg.GIF"
						style="vertical-align: middle; margin-left: 50px" /> &nbsp;&nbsp;
						<img src="./resources/images/loading.GIF" alt="loading"
...
<div id="generateCamBill" style="display: none;">
	<form id="generateCamBillForm">
		<table style="height: 205px;">
			...
			<tr id="billbasis" style="display: none">
				<td>Bill Basis</td>
				<%-- <td><kendo:dropDownList id="billbasis" name="billbasis"
						required="required" validationMessage="Select Basis of Bill">
					</kendo:dropDownList></td> --%>
					<td><select id="basisofbill"><option value="1">Monthly</option>
					            <option value="0">Daily</option></select></td>
			</tr>

			<%-- 		<tr id="camBillCAM1" style="display: none">
				<td>Bill Date</td>
				<td><kendo:datePicker format="dd/MM/yyyy  " name="camBillDateTo"
						id="camBillDateTo"></kendo:datePicker></td>
			</tr> --%>
...
$("#billGrid").on("click",".k-grid-electricityBillTemplatesDetailsExport", function(e) {
	var month = $('#monthpicker').val();
	  window.open("./electricityBillTemplate/electricityBillTemplatesDetailsExport/"+ month);
});	
$("#billGrid").on("click",".k-grid-electricityBillPdfTemplatesDetailsExport", function(e) {
	
	var month = $('#monthpicker').val();
	  window.open("./electricityBillPdfTemplate/electricityBillPdfTemplatesDetailsExport/"+ month);
});	
	...
	var cancelbillvalidator = $("#cancelAllForm").kendoValidator().data("kendoValidator");
	...
	var approvebillvalidator = $("#approveAllForm").kendoValidator().data("kendoValidator");
	...
	var postbillvalidator = $("#postAllForm").kendoValidator().data("kendoValidator");
	...
	$(document).ready(function() {
		...
		/* --------------------------------------------------- */
					/* 	 var billbasislist = [ {
						...
						$("#billbasis").kendoDropDownList({
							dataTextField : "text",
							dataValueField : "value",
							dataSource : billbasislist
						}).data("kendoDropDownList"); */
		/* --------------------------------------------------- */
...
function 	onselect(e){
	...
	function onselectedProp(){
		...
		var comboBoxDataSource = new kendo.data.DataSource({
	        transport: {
	            read: {
	                url     : "./billingGeneration/getAccountsBasedOnseletedProperty/"+propertyId,
	                dataType: "json",
	                type    : 'GET'
	            }
	        },
...
function openGenerateBill(){
	...
	function openCamBill(){
		...
		presentreading.val("");
		var presentreadingTo = $("#camBillDateTo");
		presentreadingTo.val("");
	 	...
	 	if (result == "success") {
			$.ajax({
				...
				url : "./electricityBills/cancelApproveBill/" + elBillId + "/"
						+ billStatus + "/" + accountId + "/" + "/" + serviceType + "/",
				dataType : "text",
				success : function(response) {
					$("#alertsBox").html("");
					$("#alertsBox").html(response);
...
function printAllBills() {
	...
	var serviceType = $("input[name=serviceTypePrint]").data("kendoDropDownList").text();
   ...
   var typetoPrint=  $("#typePrint").val();  
     if(typetoPrint == 'All' ){    	 
     window.open("./bill/printAllBill/" + serviceType + "/"	+ presentdate);
   
    	
     }else{
     
	window.open("./bill/printAccontWiseBill/" + serviceType + "/"+ accountNo+ "/" + presentdate + "/" + fromMonth);
...
function getDuplicateBills() {
		...
		var serviceType = $("input[name=serviceTypeDownload]").data("kendoDropDownList").text();
		var presentdate = $("#presentdateDownload").val();
		 $.ajax({
				url : "./electricityBills/getDuplicateBills/"+presentdate + "/" + serviceType,
...
function saveLatePayment() {
	...
	var presentdate = $("#presentdateDownload").val();
	 $.ajax({
			url : "./electricityBills/saveLatePayment/"+presentdate + "/" + serviceType,
	...
	//	var datepicker = $("#presentdateCam").data("kendoDatePicker");
	 ...
	 function selectallprop() {
		...
		var propertyType = $("input[name=propertyType]").data("kendoDropDownList")	.text();		  
	...
	function deleteBill() {
		...
		if(bill_status=='Paid'){
			del = confirm("Deleting a PAID Bill may irregulate your ledger entries");
			//alert("Deleting PAID Bill is Restricted From Application");
			//return false;
		}else{
			del = confirm("Are you sure to delete the bill ?");
		}
		...
		if(del==1){
			$.ajax({
				...
				dataType : "text",
				data : {
					elBillId : elBillId,bill_status:bill_status
				},
				success : function(response) {
					alert(response);
					$('#billGrid').data('kendoGrid').refresh();
	...
	//	previousCamDate = $('#previousCamDate').val();
		...
		var camBillDateTo = $('#camBillDateTo').val();
		...
		$('#camBill').hide();
		$('#loader').show();
		//alert("basis=" + $('#basisofbill').val());
		//var basis=confirm("Generate Bill On Monthly Basis");
		var monthly=$('#basisofbill').val();
/* 		if(basis){
			monthly=1;
		} */
...
/* ---------------------------------------------TallyXML----START---------------------------------------------------- */
	$("#billGrid").on("click", ".k-grid-ExportTallyDataToXML", function(e) {
		...
		var bbDialog = $("#ExportTallyXMLdiv");
		bbDialog.kendoWindow({
			width : "auto",
			height : "auto",
			modal : true,
	...
	$("#serviceTypeTallyXML").kendoDropDownList({
		dataTextField : "text",
		dataValueField : "value",
		optionLabel : {
			text : "Select",
	...
	$("#exportTallyBillData").on("click", function() {
		
		var serviceType = $("#serviceTypeTallyXML").val();
		var presentdate = $("#presentdatepostBillXML").val();
		//alert(presentdate);

		window.open("./electricityBills/exportToXML?serviceType="+serviceType+"&presentdate="+presentdate);
		closeTallyBillXML(); 
		/* var grid = $("#billGrid").getKendoGrid();
		var data = new kendo.data.DataSource();
		grid.refresh(); */
	...
	$("#ExportTallyXMLForm").submit(function(e) {
		e.preventDefault();
	});
/* ---------------------------------------------------------TallyXML END--------------------------------------------- */
