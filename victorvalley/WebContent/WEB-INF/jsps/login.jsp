...
<body onload="checkCookie();">
	...
	<div id="top">
		<div class="wrapper">
			<table style="width: 100%"><tr><td width="50%"><%-- <a href="#" title="" class="logo"> <img	src="<c:url value='/resources/images/ireo.png'/>" alt="" /> </a> --%>  <a href="#" title="" class="logo"><span style="color:#C1C1C1;font-size:20px;cursor: default;">Victory Valley</span></a> </td><td style="vertical-align: middle;" width="50%" align="right"><span style="color:#C1C1C1;font-size:15px;">${DeployVersion}</span></td></tr></table>
