...
/***********************************************Dash Board Transaction**************************************************************/
	...
	@RequestMapping(value = "/paytmTransactionReadUrl/byMonth/{from4}/{to4}", method = { RequestMethod.GET, RequestMethod.POST })
	public @ResponseBody List<?> readPaytmRecords(@PathVariable String from4 ,@PathVariable String to4) throws ParseException
	{
    	logger.info("In Online Transaction paytm... payment by month ======================");
    	List<Map<String, Object>> result = new ArrayList<Map<String, Object>>();
    	SimpleDateFormat formatter = new SimpleDateFormat("MMMM yyyy");
    	Date dateFrom = formatter.parse(from4);
    	Date dateTo = formatter.parse(to4);
		...
		System.out.println("onlineQuery-----------------"+onlinePaymentTransaction.size());
		for (final Object[] obj : onlinePaymentTransaction) {
			if(((String)obj[13]).startsWith("V"))
			{
				System.out.println("Merchant Id from VV.........................................."+(String)obj[13]);
	...
	{
    	logger.info("In Online Transaction PayU...payment by month ======================");
    	List<Map<String, Object>> result = new ArrayList<Map<String, Object>>();
    	SimpleDateFormat formatter = new SimpleDateFormat("MMMM yyyy");
