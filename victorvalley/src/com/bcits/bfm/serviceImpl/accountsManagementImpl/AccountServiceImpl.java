...
public class AccountServiceImpl extends GenericServiceImpl<Account> implements AccountService
{
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<Account> testUniqueAccount1(int personId,int propertyId){
		return entityManager.createNamedQuery("Account.testUniqueAccount1").setParameter("personId", personId).setParameter("propertyId", propertyId).getResultList();		
	}
