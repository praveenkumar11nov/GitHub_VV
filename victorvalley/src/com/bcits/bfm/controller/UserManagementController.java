	...
	{		
		...
		if(contact.size() != 0)
		{
		 ...
		 String messageContent="<html>"
					...
					+ "}"
					+ "</style>"
					+ "<h2  align=\"center\"  style=\"background-color:#88ab74;\">VICTORY VALLEY ADMINISTRATION DEPARTMENT</h2> <br /> Dear "+ name + ", Welcome to VICTORY VALLEY <br/> <br/> "
					...
					+ "<br/><br/>"
					+ "<br/>Thanks,<br/>"
					+ "Victory Valley Administration Department <br/> <br/>"
					+"</body></html>";	
			...
			for (Iterator iterator = contact.iterator(); iterator.hasNext();) {
				...
				if((contact2.getContactType().equalsIgnoreCase("Email")) && (contact2.getContactPrimary().equalsIgnoreCase("Yes"))){
					...
					logger.info("************************** Login Name"+user.getUrLoginName()+"******************************");  
					 String messageContent="<html>"
								...
								+ "}"
								+ "</style>"
								+ "<h2  align=\"center\"  style=\"background-color:#88ab74;\">VICTORY VALLEY RWA ADMINISTRATION DEPARTMENT.</h2> <br /> Dear "+ user.getPerson().getFirstName() + ", Welcome to Victory Valley RWA <br/> <br/> "
				...
				if((contact2.getContactType().equalsIgnoreCase("Mobile")) && (contact2.getContactPrimary().equalsIgnoreCase("Yes"))){
					mobileNo=contact2.getContactContent();
					    ...
					    String userMessage = "Dear "+user.getPerson().getFirstName()+", Your account has been "+"Activated"+". Your account details are username : "+user.getUrLoginName()+" & password : "+personPassword+" - Victory Valley RWA  Administration services.";	
			...
			if(level == 0){
				...
				for (Iterator iterator = contact.iterator(); iterator.hasNext();) {
					...
					if((contact2.getContactType().equalsIgnoreCase("Email")) && (contact2.getContactPrimary().equalsIgnoreCase("Yes"))){
						...
						EmailCredentialsDetailsBean emailCredentialsDetailsBean=null;
						 ...
						 String messageContent="<html>"
									...
									+ "}"
									+ "</style>"
									+ "<h2  align=\"center\"  style=\"background-color:#88ab74;\">VICTORY VALLEY  ADMINISTRATION DEPARTMENT</h2> <br /> Dear "+ user.getPerson().getFirstName() + ", Welcome to VICTORY VALLEY <br/> <br/> "
									+ "Please use following UserName and Password to login. <br/> <br/>"
									+ "<table class=\"hovertable\" >" + "<tr>"
									+ "<td colspan='2'>Your Account Details are</td>"
									+ "</tr>" + "<tr>" + "<td> User Name :</td>"
					...
					if((contact2.getContactType().equalsIgnoreCase("Mobile")) && (contact2.getContactPrimary().equalsIgnoreCase("Yes"))){
						...
						mobileNo=contact2.getContactContent();
						 String userMessage = "Dear "+user.getPerson().getFirstName()+", Your account has been "+"Activated"+". Your account details are username : "+user.getUrLoginName()+" & password : "+personPassword+" - VICTORY VALLEY  Administration services.";	
