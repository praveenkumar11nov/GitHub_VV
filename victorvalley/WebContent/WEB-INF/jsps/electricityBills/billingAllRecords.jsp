...
<div id="loading" ></div>
	<kendo:grid name="grid" pageable="true"
      ...
      <div class="toolbar">
        ...
        <kendo:grid-column title="Service Type &nbsp; *" filterable="false" field="serviceType" width="130px">
        </kendo:grid-column>
        
              <%-- <kendo:grid-column title="Billed Amount &nbsp; *" filterable="false" field="billAmount" width="130px">
        </kendo:grid-column>  --%>
    ...
    function searchByMonth() {
		...
		alert(":::month::::"+month);
		 ...
		 $.ajax({
			type : "POST",
			url : "./bill/readAllBillData/" + month+ "/" + "${data}",
			dataType : "json",
