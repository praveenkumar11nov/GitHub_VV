	...
	String address=req.getParameter("address");
		...
		SmsCredentialsDetailsBean smsCredentialsDetailsBean = new SmsCredentialsDetailsBean();
			  ...
			  String messageContentForPerson = "<html>"         
			    ...
			    + "}"
			    + "</style>"
			    + "<h2  align=\"center\"  style=\"background-color:#88ab74;\">Victory Valley RWA GROCERY SERVICES.</h2> <br /> Dear "+cname+", <br/> <br/> "
			  ...
			  String messagePerson = "grocery services from Victory Valley RWA.This sms is to inform you that your Grocery Order is placed successfully with your contact no as"+Phone+" created on "+ new Timestamp(new java.util.Date().getTime()).toLocaleString()
			    +"Thank you and Have a nice day"; 
			  
			  String StorePerson = " Victory Valley RWA.This sms is to inform you that new Order has come , created on "+ new Timestamp(new java.util.Date().getTime()).toLocaleString()
					    +"Thank you and Have a nice day"; ;
	   ...
	   EmailCredentialsDetailsBean emailCredentialsDetailsBean = new EmailCredentialsDetailsBean();
		SmsCredentialsDetailsBean smsCredentialsDetailsBean = new SmsCredentialsDetailsBean();
		  ...
		  String messageContentForPerson = "<html>"         
		    ...
		    + "}"
		    + "</style>"
		    + "<h2  align=\"center\"  style=\"background-color:#88ab74;\">Victory Valley RWA GROCERY SERVICES.</h2> <br /> Dear customer, <br/> <br/> "
		  ...
		  String messagePerson = "grocery services from Victory Valley RWA.This sms is to inform you that your Grocery enquiry is  responded and list is uploaded.Please login into application and verify.Response date "+ new Timestamp(new java.util.Date().getTime()).toLocaleString()
		    +"Thank you and Have a nice day"; 
