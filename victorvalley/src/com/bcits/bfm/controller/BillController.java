...
public class BillController {
		...
		if (interestType != null) {
			if (interestType.trim().equalsIgnoreCase("Daywise")) {
				...
				if (amountForInteresetCal>0) {
					ELRateMaster elRateMaster = rateMasterService
							.find(rateMasterID);
					Calendar cal = Calendar.getInstance();
					cal.setTime(electricityBillEntity.getBillDueDate());
					logger.info("::::::::::"
					...
					Date nextBillDate = cal.getTime();
					logger.info("nextBillDate ------------------ "
							+ nextBillDate);
					consolidatedBill = calculationController.interstAmount(
							elRateMaster,
							electricityBillEntity.getBillDueDate(),
							nextBillDate, amountForInteresetCal);
					for (Entry<Object, Object> map1 : consolidatedBill
							.entrySet()) {
						if (map1.getKey().equals("total")) {
							interestAmountAfterDueDate = interestAmountAfterDueDate
									+ (Float) map1.getValue();
	...
	/*
		Date currentBillDate = (Date) billEntity.getToDate();
		Date lastBillDate = (Date) billEntity.getFromDate();		*/
		...
		CAMBillsController.writeToFile("currentBillDate="+currentBillDate+" lastBillDate="+lastBillDate+" diffMonth="+diffMonth+" Return="+(diffMonth+1));
	/*	
		Calendar cal1 = Calendar.getInstance(); 
		...
		System.out.println(" fromDate="+fromDate+"..........toDate="+toDate+"..........DaysDifference="+monthDiff);
	*/	
	...
	public void getBillDoc(int elBillId, Locale locale,int monthly) {
		...
		if (electricityBillEntity != null) {
			...
			if (electricityBillEntity.getTypeOfService().equals("CAM")) {
				...
				//double checquebounceAmount=electricityBillsService.getLineItemAmountBasedOnTransactionCode(electricityBillEntity.getElBillId(),"EL_CP");
				...
				//double monthdiff=Math.round(camBillsController.getNoDaysDiff(electricityBillEntity)*10000)/10000;
				DecimalFormat df = new DecimalFormat("#.##");
									
				 double monthdiff=0;
				 if(monthly==0){
					 perdaycalc=Double.parseDouble(df.format((totalCamRates/365)*12));
			  ...
			  //param.put("camPointValue8", sEducationAmount);
			   ...
			   // param.put("name", electricityBillEntity.getAccountObj().getPerson().getFirstName()+ " "+middleName +" "+lastName+" "+co_ownerFirstName+" "+co_ownerMiddleName+" "+co_ownerLastName);	
				...
				/*Calendar cal = Calendar.getInstance();
				System.err.println(".....................................PreviousBillstatus=" + camBillsController.previousBillstatus);
				if(camBillsController.previousBillstatus.equalsIgnoreCase("FirstBill")){
					System.err.println("......................................FirstBill................................");
					cal = Calendar.getInstance();
					cal.setTime(electricityBillEntity.getBillDate());
					cal.set(Calendar.DAY_OF_MONTH, cal.getActualMaximum(Calendar.DAY_OF_MONTH));
					cal.add(Calendar.DATE, 1);
					param.put("billingPeriod",DateFormatUtils.format((electricityBillEntity.getFromDate()),"dd MMM. yyyy")+ " To "+ DateFormatUtils.format((cal.getTime()),"dd MMM. yyyy"));
				}else {
					System.err.println("......................................NotFirstBill................................");
				...
				param.put("billingPeriod",DateFormatUtils.format((electricityBillEntity.getFromDate()),"dd MMM. yyyy")+ " To "+ DateFormatUtils.format((electricityBillEntity.getToDate()),"dd MMM. yyyy"));
				param.put("caNo", electricityBillEntity.getAccountObj().getAccountNo());
