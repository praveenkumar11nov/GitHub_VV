...
@NamedQueries({
	...
	@NamedQuery(name="Blocks.getBlockName",query="SELECT b.blockId FROM Blocks b WHERE b.blockName=:value"),
	@NamedQuery(name="Blocks.getProjectId",query="SELECT b.projectId FROM Blocks b WHERE b.blockName=:value2"),
