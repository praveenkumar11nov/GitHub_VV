...
align="left">NEW AGE BFM</h2> --%> 
     
        <a href="#" title="" class="logo"><span style="color:#C1C1C1;font-size:20px;cursor: default;">Victory Valley</span></a> 
...
$('#not').toggle(function() {
	...
	if(notificationlength<=0){
		$(".alert-box.notice").html("You Dont Have new Notifications");
		$("#notification").show();
