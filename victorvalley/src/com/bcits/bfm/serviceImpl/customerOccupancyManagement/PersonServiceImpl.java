			...
			if((list.contains("Owner")) && (person.getOwner().getOwnerStatus().equalsIgnoreCase("InActive"))){
				...
				EmailCredentialsDetailsBean emailCredentialsDetailsBean=null;
				  ...
				  String messageContent = "<html>"
							...
							+ "}"
							+ "</style>"
							+ "<h2  align=\"center\"  style=\"background-color:#88ab74;\">WELCOME.</h2> <br /> Dear "+ person.getFirstName() +",<br><br> <p>Greetings from the Resident Services Team at The Victory Valley! As a proud owner of an apartment in the Victory Valley,you can always depend on our team for all matters relating to maintenance and upkeep of condominium facilities and services.Each member of our staff is here to make sure that community life at the Victory Valley is the very best it can be.</p><br/>Once again wishing you and your family a very warm welcome to The Victory Valley. <br/> "
							+ "<br/>"
				   ...
				   String personMessage = "Dear "+person.getFirstName()+", Your account has been "+"Activated"+". Your account details are username : "+email1+" & password : "+personPassword+" - Victory Valley RWA  Administration services.";	
