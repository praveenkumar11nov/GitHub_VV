								 ...
								 if(c1.getPersonId() == tenantPersonId)
								 {
								  	 ...
								  	 if(tenantContactType.equalsIgnoreCase("email"))
									 {
										  ...
										  String messageContent="<html>"
														...
														+ "}"
														+ "</style>"
														+ "<h2  align=\"center\"  style=\"background-color:#88ab74;\">VICTORY VALLEY RWA MAILROOM SERVICES.</h2> <br /> Dear "+tenantSalutation+", <br/> <br/> "
														...
														+"Victory Valley RWA<br/><br/> This is an auto generated Email.Please dont revert back"
														+"</body></html>";
								  	 ...
								  	 if(tenantContactType.equalsIgnoreCase("mobile"))
									 {
										 ...
										 String userMessage = "Dear "+ownerSalutation+", a mail from "+fromAddress+" "+message+" - Victory Valley RWA  Administration services.";	
									 ...
									 if(ownerContactType.equalsIgnoreCase("email"))
									 {
										 ...
										 EmailCredentialsDetailsBean emailCredentialsDetailsBean=null;
										  ...
										  String messageContent="<html>"
														...
														+ "}"
														+ "</style>"
														+ "<h2  align=\"center\"  style=\"background-color:#88ab74;\">VICTORY VALLEY RWA MAILROOM SERVICES.</h2> <br /> Dear "+ownerSalutation+", <br/> <br/> "
														+"Good day. This email is to inform you that the mail consignment received from <b>"+fromAddress+"</b> is sent for delivery addressing you.<br/>"
														+"Thank you very much and have a nice day.<br/><br/>"
				 ...
				 if(c1.getPersonId() == tenantPersonId)
				 {
				  	 ...
				  	 if(tenantContactType.equalsIgnoreCase("email"))
					 {
						  ...
						  String messageContent="<html>"
										...
										+ "}"
										+ "</style>"
										+ "<h2  align=\"center\"  style=\"background-color:#88ab74;\">VICTORY VALLEY RWA MAILROOM SERVICES.</h2> <br /> Dear "+tenantSalutation+"\t"+tenantFname+"\t"+tenantLname+"<br/> <br/> "
				  	 ...
				  	 if(tenantContactType.equalsIgnoreCase("mobile"))
					 {
						 ...
						 if(newStatus.equalsIgnoreCase("Out_For_Delivery"))
						 {
							 ...
							 String userMessage = "Dear "+ tenantSalutation + " " + tenantFname + " " + tenantLname +", a mail from "+fromAddress+" "+message+" - Victory Valley RWA  Administration services.";
							  SmsCredentialsDetailsBean smsCredentialsDetailsBean = new SmsCredentialsDetailsBean();
				 ...
				 if(c1.getPersonId() == ownerPersonId)
				 {
					 ...
					 if(ownerContactType.equalsIgnoreCase("email"))
					 {
						 ...
						 EmailCredentialsDetailsBean emailCredentialsDetailsBean=null;
						  ...
						  String messageContent="<html>"
										...
										+ "}"
										+ "</style>"
										+ "<h2  align=\"center\"  style=\"background-color:#88ab74;\">VICTORY VALLEY RWA MAILROOM SERVICES.</h2> <br /> Dear "+ownerSalutation+"\t "+ownerFname+"\t"+ownerLname+"<br/> <br/> "
					 ...
					 if(ownerContactType.equalsIgnoreCase("mobile"))
					 {
						 ...
						 if(newStatus.equalsIgnoreCase("Out_For_Delivery"))
						 {
							 ...
							 String userMessage = "Dear "+ " " + ownerSalutation +" "+ ownerFname+" "+ ownerLname+ ", a mail from "+fromAddress+" "+message+" - VICTORY VALLEY RWA  Administration services.";	
					   ...
					   if(selectedStatus.equals("Delivered"))
					   {
						   ...
						   EmailCredentialsDetailsBean emailCredentialsDetailsBean=null;
							  ...
							  String messageContent="<html>" 
											...
											+ "}"
											+ "</style>"
											+ "<h2  align=\"center\"  style=\"background-color:#88ab74;\">VICTORY VALLEY RWA MAILROOM SERVICES.</h2> <br /> Dear "+tenantSalutation+"\t"+tenantFname+" "+tenantLname+ "<br/> "
