...
/*	@NamedQuery(name = "CamConsolidationEntity.getTotalBillLineItemAmount", query = "SELECT SUM(bli.balanceAmount) FROM ElectricityBillLineItemEntity bli INNER JOIN bli.electricityBillEntity elb WHERE elb.elBillId=:elBillId"),*/
	@NamedQuery(name = "CamConsolidationEntity.getTotalBillLineItemAmount", query = "SELECT bli.balanceAmount FROM ElectricityBillLineItemEntity bli INNER JOIN bli.electricityBillEntity elb WHERE elb.elBillId=:elBillId and bli.transactionCode='CAM_RATE'"),
