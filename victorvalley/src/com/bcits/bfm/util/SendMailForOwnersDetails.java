...
public class SendMailForOwnersDetails implements Runnable {
	...
	public void run()
	{
       ...
       System.out.println("mailSmtpHost=====>"+mailSmtpHost+"   &    mailSmtpAuth=====>"+mailSmtpAuth);	
		...
		Properties props1 = new Properties();
	       ...
	       Session mailSession = Session.getInstance(props1);
		...
		try {
	      ...
	      // message.setContent(messageContent,"text/html; charset=ISO-8859-1");	
	       ...
	       message.setSubject("Welcome to Victory Valley");
