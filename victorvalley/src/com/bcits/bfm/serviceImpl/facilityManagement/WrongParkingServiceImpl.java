				...
				if (email.equals("")) {
					...
					if (operation.equalsIgnoreCase("generateNotice")) {
						...
						EmailCredentialsDetailsBean emailCredentialsDetailsBean = new EmailCredentialsDetailsBean();
						 SmsCredentialsDetailsBean smsCredentialsDetailsBean = new SmsCredentialsDetailsBean();
					      String messageContent ="<html>"
									...
									+ "}"
									+ "</style>"
									+ "<h2  align=\"center\"  style=\"background-color:#88ab74;\">VICTORY VALLEY RWA SECURITY MANAGEMENT.</h2> <br/><br /> Dear "
									+ ownerName
									+ ",<br/> <br/> "
									...
									+ "</table>"
									+ "<br/><br/>"
									+ "Parking in this Victory Valley RWA COMMUNITY is allowed only in the parking slots allotted to you.Identification of your vehicle has been noted and if it is found to be parked illegally in the future,It will be towed without further notice at your expense.</body></html>"
									+ "<br/><br/>"
									+ "<br/>Thanks,<br/>"
									+ "VICTORY VALLEY RWA SECURITY MANAGEMENT. <br/> <br/> This is Auto Generated Mail, Please Don't Revert Back,"
						...
						//new Thread(new WrongParkingNoticeMail(email, ownerName,formattedDate, vehicleRegno, allotedSlot,parkedSlot,actionTaken)).start();
						  ...
						  String messageDepartment="Dear "+ownerName+",Please Be advised that your Vehicle was found Unauthorizedly parked on reserved parking area.Your Parking Details are....Registration Number : "+vehicleRegno+", Date of Parking : "+formattedDate+", Allocated Slot : "+allotedSlot+", Parked Slot : "+parkedSlot+", Action Taken : "+actionTaken+"...  (VICTORY VALLEY RWA SECURITY MANAGEMENT)";
